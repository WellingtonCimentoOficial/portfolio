...
export const projectData: ProjectType[] = [
    ...
    },
    {
        ...
        description: "Esse script conseguirá controlar sua lâmpada Yeelight Smart LED Bulb (Color) através de um terminal Linux ou Windows utilizando funções básicas como ligar, desligar, brilho, saturação, temperatura e cores pré-definidas, podendo assim ser desenvolvido softwares mais complexos com base nesse código. Através dessa ideia poderá ser criado softwares, como algum programa de áudio que tem como funcionalidade fazer com que a lâmpada execute uma função desejada de acordo com a batida de uma música, poderá utilizar junto a uma inteligência artificial executando assim comandos de voz e etc. Esses foram apenas 2 exemplos, daqui para frente vai da sua criatividade criar algum software que tenha outras funcionalidades e outros objetivos. Obs: Esse código não foi testado em outro modelo além do descrito acima.",
        images: {
            logo: {
                id: 0,
